/**
 * build-sermon-on-the-mount-as-politics-pdf.mjs — render the "The Sermon on the Mount as Politics" manuscript
 * (content/books/sermon-on-the-mount-as-politics.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/sermon-on-the-mount-as-politics.md");
const OUT = path.join(ROOT, "api/_ebooks/sermon-on-the-mount-as-politics.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412";
const TITLE = "The Sermon on the Mount as Politics";
const SUBTITLE = "Reading the Kingdom's Constitution Without the Spiritualizing";
const AUTHOR = "James Bell";
const EPIGRAPH = "The Sermon on the Mount is the most complete delineation anywhere in the New Testament of the Christian counter-culture.";
const EPIGRAPH_BY = "John Stott, 1978";
