/**
 * build-after-christendom-pdf.mjs — render the "After Christendom" manuscript
 * (content/books/after-christendom.md) into the gated ebook PDF served by
 * /api/download. Run:  node scripts/build-after-christendom-pdf.mjs
 *
 * Idempotent: overwrites api/_ebooks/after-christendom.pdf each run.
 */
...
const SRC = path.join(ROOT, "content/books/after-christendom.md");
const OUT = path.join(ROOT, "api/_ebooks/after-christendom.pdf");
...
const EPIGRAPH = "Seek the welfare of the city where I have sent you into exile, and pray to the Lord on its behalf, for in its welfare you will find your welfare.";
const EPIGRAPH_BY = "Jeremiah 29:7";
