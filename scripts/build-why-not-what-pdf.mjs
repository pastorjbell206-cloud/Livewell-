/**
 * build-why-not-what-pdf.mjs — render the "Why Not What" manuscript
 * (content/books/why-not-what.md) into the gated ebook PDF served by
 * /api/download.
...
const SRC = path.join(ROOT, "content/books/why-not-what.md");
const OUT = path.join(ROOT, "api/_ebooks/why-not-what.pdf");
...
const EPIGRAPH = "You have made us for yourself, and our heart is restless until it rests in you.";
const EPIGRAPH_BY = "Augustine, Confessions, 397";
