/**
 * build-what-belongs-to-the-poor-pdf.mjs — render the "What Belongs to the Poor"
 * manuscript (content/books/what-belongs-to-the-poor.md) into the gated ebook PDF
 * served by /api/download. Run:  node scripts/build-what-belongs-to-the-poor-pdf.mjs
 *
...
const SRC = path.join(ROOT, "content/books/what-belongs-to-the-poor.md");
const OUT = path.join(ROOT, "api/_ebooks/what-belongs-to-the-poor.pdf");
...
const EPIGRAPH = "The bread you are storing up belongs to the hungry. The cloak kept in your closet belongs to the naked. The money you have buried belongs to the poor.";
const EPIGRAPH_BY = "Basil of Caesarea";
