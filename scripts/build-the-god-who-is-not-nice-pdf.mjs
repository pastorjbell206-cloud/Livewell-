/**
 * build-the-god-who-is-not-nice-pdf.mjs — render the "The God Who Is Not Nice" manuscript
 * (content/books/the-god-who-is-not-nice.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/the-god-who-is-not-nice.md");
const OUT = path.join(ROOT, "api/_ebooks/the-god-who-is-not-nice.pdf");
...
const EPIGRAPH = "What comes into our minds when we think about God is the most important thing about us.";
const EPIGRAPH_BY = "A. W. Tozer, The Knowledge of the Holy, 1961";
...
const doc = new PDFDocument({ size: "A5", margins: { top: 60, bottom: 64, left: 58, right: 58 }, info: { Title: TITLE, Author: AUTHOR } });
