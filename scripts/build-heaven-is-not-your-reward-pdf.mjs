/**
 * build-heaven-is-not-your-reward-pdf.mjs — render the "Heaven Is Not Your Reward" manuscript into the gated PDF.
...
const SRC = path.join(ROOT, "content/books/heaven-is-not-your-reward.md");
const OUT = path.join(ROOT, "api/_ebooks/heaven-is-not-your-reward.pdf");
...
const EPIGRAPH = "Behold, I am making all things new.";
const EPIGRAPH_BY = "The voice from the throne, Revelation 21";
