/**
 * build-how-to-read-the-bible-pdf.mjs — render the "How to Read the Bible"
 * manuscript (content/books/how-to-read-the-bible.md) into the gated ebook PDF
 * served by /api/download. Run:  node scripts/build-how-to-read-the-bible-pdf.mjs
 *
...
const SRC = path.join(ROOT, "content/books/how-to-read-the-bible.md");
const OUT = path.join(ROOT, "api/_ebooks/how-to-read-the-bible.pdf");
...
const EPIGRAPH = "Do your best to present yourself to God as one approved, a worker who has no need to be ashamed, rightly handling the word of truth.";
const EPIGRAPH_BY = "2 Timothy 2:15";
