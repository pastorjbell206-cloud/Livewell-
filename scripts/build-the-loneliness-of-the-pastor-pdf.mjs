/**
 * build-the-loneliness-of-the-pastor-pdf.mjs — render the "The Loneliness of the Pastor" manuscript
 * (content/books/the-loneliness-of-the-pastor.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/the-loneliness-of-the-pastor.md");
const OUT = path.join(ROOT, "api/_ebooks/the-loneliness-of-the-pastor.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412";
const TITLE = "The Loneliness of the Pastor";
const SUBTITLE = "Why Pastors Quit, and the Brotherhood That Could Let Them Stay";
const AUTHOR = "James Bell";
const EPIGRAPH = "It is enough; now, O Lord, take away my life, for I am no better than my fathers.";
const EPIGRAPH_BY = "Elijah, under the broom tree, First Kings 19";
