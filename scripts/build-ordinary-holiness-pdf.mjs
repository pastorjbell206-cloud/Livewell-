/**
 * build-ordinary-holiness-pdf.mjs — render the "Ordinary Holiness" manuscript
 * (content/books/ordinary-holiness.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/ordinary-holiness.md");
const OUT = path.join(ROOT, "api/_ebooks/ordinary-holiness.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412";
const TITLE = "Ordinary Holiness";
const SUBTITLE = "Finding God in the Life You Actually Have";
const AUTHOR = "James Bell";
const EPIGRAPH = "The world is charged with the grandeur of God.";
const EPIGRAPH_BY = "Gerard Manley Hopkins, 1877";
