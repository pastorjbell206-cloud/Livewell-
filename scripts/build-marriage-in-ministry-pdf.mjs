/**
 * build-marriage-in-ministry-pdf.mjs — render the "Marriage in Ministry" manuscript
 * (content/books/marriage-in-ministry.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/marriage-in-ministry.md");
const OUT = path.join(ROOT, "api/_ebooks/marriage-in-ministry.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412";
const TITLE = "Marriage in Ministry";
const SUBTITLE = "Protecting the Covenant When the Church Demands Everything";
const AUTHOR = "James Bell";
const EPIGRAPH = "Therefore a man shall leave his father and his mother and hold fast to his wife, and they shall become one flesh.";
const EPIGRAPH_BY = "Genesis 2, verse 24";
