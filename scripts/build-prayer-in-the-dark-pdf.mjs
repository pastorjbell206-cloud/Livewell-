/**
 * build-prayer-in-the-dark-pdf.mjs — render the "Prayer in the Dark" manuscript into the gated PDF.
...
const SRC = path.join(ROOT, "content/books/prayer-in-the-dark.md");
const OUT = path.join(ROOT, "api/_ebooks/prayer-in-the-dark.pdf");
...
const EPIGRAPH = "The Spirit helps us in our weakness. We do not know what to pray for as we ought, but the Spirit himself intercedes for us with groanings too deep for words.";
const EPIGRAPH_BY = "Paul, Romans 8";
