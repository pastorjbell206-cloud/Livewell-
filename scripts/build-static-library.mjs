/**
 * build-static-library.mjs — turn the drafted essays into a static library
 ...
 *   2. Emit content/static-library.generated.json and its identical prod
 *      mirror api/static-library.generated.ts — arrays of fully-shaped
...
const banner =
  ...
  "// The long-form essay library, shaped for api/index.ts to serve behind the live DB.\n" +
  "/* eslint-disable */\n";
writeFileSync(
  outPath,
