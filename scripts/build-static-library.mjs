...
import { applyToLibrary, loadRewrites } from "./apply-rewrites.mjs";
...
const allRecords = applyToLibrary(records.concat(bridgeRecords, draftRecords, pcRecords), loadRewrites()).records;
