/**
 * build-the-body-you-left-pdf.mjs — render the "The Body You Left" manuscript into the gated PDF.
...
const SRC = path.join(ROOT, "content/books/the-body-you-left.md");
const OUT = path.join(ROOT, "api/_ebooks/the-body-you-left.pdf");
...
const EPIGRAPH = "Now you are the body of Christ, and individually members of it.";
const EPIGRAPH_BY = "Paul, First Corinthians 12";
