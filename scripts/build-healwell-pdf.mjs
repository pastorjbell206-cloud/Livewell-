/**
 * build-healwell-pdf.mjs — render the "HealWell" manuscript
 * (content/books/healwell.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/healwell.md");
const OUT = path.join(ROOT, "api/_ebooks/healwell.pdf");
...
const EPIGRAPH = "He heals the brokenhearted and binds up their wounds.";
const EPIGRAPH_BY = "Psalm 147, verse 3";
