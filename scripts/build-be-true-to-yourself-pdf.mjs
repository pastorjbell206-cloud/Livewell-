/**
 * build-be-true-to-yourself-pdf.mjs — render the "Be True to Yourself"
 * manuscript (content/books/be-true-to-yourself.md) into the gated ebook PDF
 * served by /api/download. Run:  node scripts/build-be-true-to-yourself-pdf.mjs
 *
...
const SRC = path.join(ROOT, "content/books/be-true-to-yourself.md");
const OUT = path.join(ROOT, "api/_ebooks/be-true-to-yourself.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412"; // darkened for white paper
const TITLE = "Be True to Yourself";
const SUBTITLE = "The Lie That Ate the World";
const AUTHOR = "James Bell";
const EPIGRAPH = "You are not your own, for you were bought with a price.";
const EPIGRAPH_BY = "1 Corinthians 6:19-20";
