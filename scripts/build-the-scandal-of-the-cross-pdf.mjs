/**
 * build-the-scandal-of-the-cross-pdf.mjs — render the "The Scandal of the Cross" manuscript into the gated PDF.
...
const SRC = path.join(ROOT, "content/books/the-scandal-of-the-cross.md");
const OUT = path.join(ROOT, "api/_ebooks/the-scandal-of-the-cross.pdf");
...
const EPIGRAPH = "We preach Christ crucified, a stumbling block to Jews and folly to Gentiles, but to those who are called, the power of God and the wisdom of God.";
const EPIGRAPH_BY = "Paul, First Corinthians 1";
