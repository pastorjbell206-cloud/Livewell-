/**
 * build-faith-after-deconstruction-pdf.mjs — render the "Faith After Deconstruction" manuscript
 * (content/books/faith-after-deconstruction.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/faith-after-deconstruction.md");
const OUT = path.join(ROOT, "api/_ebooks/faith-after-deconstruction.pdf");

const INK = "#14110C";
const MUTED = "#5A5448";
const MUSTARD = "#9A7412";
const TITLE = "Faith After Deconstruction";
const SUBTITLE = "How to Lose the Faith You Were Given and Find the One That Holds";
const AUTHOR = "James Bell";
const EPIGRAPH = "I believe, help my unbelief.";
const EPIGRAPH_BY = "A father, to Jesus, in Mark 9";
