/**
 * build-born-again-from-atheism-pdf.mjs — render the "Born Again From Atheism" manuscript
 * (content/books/born-again-from-atheism.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/born-again-from-atheism.md");
const OUT = path.join(ROOT, "api/_ebooks/born-again-from-atheism.pdf");
...
const EPIGRAPH = "The steady, unrelenting approach of Him whom I so earnestly desired not to meet.";
const EPIGRAPH_BY = "C. S. Lewis, Surprised by Joy, 1955";
