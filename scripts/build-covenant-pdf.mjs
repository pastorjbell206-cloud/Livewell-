/**
 * build-covenant-pdf.mjs — render the "Covenant" manuscript
 * (content/books/covenant.md) into the gated ebook PDF served by /api/download.
...
const SRC = path.join(ROOT, "content/books/covenant.md");
const OUT = path.join(ROOT, "api/_ebooks/covenant.pdf");
...
const EPIGRAPH = "It is not your love that sustains the marriage, but from now on, the marriage that sustains your love.";
const EPIGRAPH_BY = "Dietrich Bonhoeffer, from a wedding sermon written in prison, 1943";
