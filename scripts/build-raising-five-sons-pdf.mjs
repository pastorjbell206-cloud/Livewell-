/**
 * build-raising-five-sons-pdf.mjs — render the "Raising Five Sons" manuscript
 * (content/books/raising-five-sons.md) into the gated ebook PDF served by
 * /api/download.
 * Run:  node scripts/build-raising-five-sons-pdf.mjs
 *
 * Idempotent: overwrites api/_ebooks/raising-five-sons.pdf each run.
 */
...
const SRC = path.join(ROOT, "content/books/raising-five-sons.md");
const OUT = path.join(ROOT, "api/_ebooks/raising-five-sons.pdf");
...
const EPIGRAPH = "A father of the fatherless and a protector of widows is God in his holy habitation.";
const EPIGRAPH_BY = "Psalm 68, verse 5";
