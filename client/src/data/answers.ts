...
export const ANSWERS: Answer[] = [
  {
    ...
    essayTitle: "Did Jesus Really Rise from the Dead? Weighing the Evidence",
  ...
  },
  {
    ...
    essayTitle: "Can You Trust the Bible? What the Historical Evidence Shows",
    bookTitle: "The Reliability of Scripture",
    bookHref: "/books/the-reliability-of-scripture",
  },
  {
  ...
  },
  {
    ...
    essayTitle: "Can You Be a Christian Without Going to Church?",
  ...
  },
  {
    ...
    essaySlug: "why-people-are-leaving-the-church",
    essayTitle: "Why Are People Leaving the Church? The Rise of the Nones",
    bookTitle: "The Body You Left",
    bookHref: "/the-body-you-left",
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "You can be good without God, and pretending otherwise is the lie that discredits every true thing standing near it. Atheists are not, as a class, worse neighbors or parents or citizens than the people filling pews, and any pastor who has done funerals for long knows it. The claim was never that unbelievers cannot behave well. The real question is quieter. Not whether an atheist can be good, but what makes the word good point at anything real when he says it.",
    ...
    essayTitle: "Can You Be Good Without God? Where Morality Really Comes From",
    bookTitle: "Born Again From Atheism",
    bookHref: "/born-again-from-atheism",
  },
  {
  ...
  },
  {
    ...
    essayTitle: "Can a Reasonable Person Believe in Miracles? Hume and His Critics",
    bookTitle: "The Scandal of the Cross",
    bookHref: "/the-scandal-of-the-cross",
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Faithful churches divide on this, and they divide hard, so I will tell you honestly that this is second-order ground and not the confessional floor. Much of the Reformed and Baptist world holds that the one truly saved is kept by God and cannot finally be lost. Much of the Wesleyan, Arminian, and Catholic world holds that salvation can be forfeited. Both sides are reading the same Bible and loving the same Christ.",
      "The case for security rests where you would want it to rest, on God's grip rather than yours. \"I give them eternal life, and they will never perish, and no one will snatch them out of my hand\" (John 10:28), and Paul is sure that he who began a good work will bring it to completion (Philippians 1:6). The case for the other side rests on the warnings meaning what they say. Hebrews addresses people who have tasted the heavenly gift and speaks of falling away (Hebrews 6:4-6), and Jesus speaks of branches that do not abide being cut off (John 15:6). A freedom that cannot walk away is not the love of persons but the holding of objects.",
      "Here is the pastoral heart of it, and it is the part that matters most for the person actually afraid. Both traditions, rightly held, produce the same posture: a humble clinging to Christ rather than careless presumption or gnawing terror. If you are lying awake afraid you have fallen away, that fear is not usually the mark of someone who has. The settled apostate does not agonize. Do not resolve your anxiety by picking the doctrine that soothes it. Resolve it by going back to the one who said he would not let go.",
    ],
    essaySlug: "can-you-lose-your-salvation",
    essayTitle: "Can You Lose Your Salvation?",
    bookTitle: "Faith After Deconstruction",
    bookHref: "/faith-after-deconstruction",
  },
  {
    slug: "is-anxiety-a-spiritual-failure",
    question: "Is my anxiety a spiritual failure?",
    paragraphs: [
      "No. Anxiety is not a verdict on your faith, and the person who told you it was did you real harm. I am a pastor and not a physician, and none of this is medical advice, but I have sat with enough people in enough dark rooms to know the difference between someone faking and someone drowning. The first thing the church owes anyone drowning is to stop debating the water and get in it.",
      "Two bad answers get handed out here, and each one gets something right before it goes wrong. The pietist says be anxious for nothing, so if you are anxious you are sinning, which takes seriously that God invites us out of fear and then turns the invitation into a whip. The purely clinical answer says it is only chemistry and the soul has nothing to do with it, which takes seriously that the body is genuinely involved and then leaves the person alone with a machine. Philippians 4:6-7 is not a command to white-knuckle a feeling away. It is an invitation to bring the thing to God. And when Elijah wanted to die, God did not begin with theology. He gave him food and sleep first (1 Kings 19).",
      "So lament is faith rather than its failure, roughly a third of the Psalms will teach you the language, and getting help is a gift to receive rather than a defeat to hide. A doctor, a counselor, medicine, one trusted person who will stay. If you have reached the place where you are not sure you want to be here at all, tell someone today, and in the United States you can call or text 988 right now. That sentence matters more than anything else on this page. God was never keeping score. He was watching the road.",
    ],
    essaySlug: "anxiety-and-faith",
    essayTitle: "Is My Anxiety a Spiritual Failure?",
    bookTitle: "Prayer in the Dark",
    bookHref: "/prayer-in-the-dark",
  },
  {
    slug: "is-hell-forever-or-does-it-end",
    question: "Is hell forever, or does it end?",
    paragraphs: [
      "The reality of judgment and of being finally separated from God is the church's historic teaching and sits near the confessional core. The exact nature and duration of hell is a different matter, and Bible-loving Christians have genuinely disagreed about it. I am not going to fake a consensus that does not exist.",
      "Three views have been held by serious believers. The traditional and majority view is eternal conscious separation and suffering, resting on texts like \"these will go away into eternal punishment, but the righteous into eternal life\" (Matthew 25:46). Conditional immortality, or annihilationism, holds that the finally impenitent are not kept alive forever in torment but at last perish, resting on Jesus warning of the one who can \"destroy both soul and body in hell\" (Matthew 10:28) and on the wages of sin being death (Romans 6:23). John Stott expressed sympathy for this reading, and Edward Fudge argued it at length. A minority hope of final restoration has appeared in church history, in Gregory of Nyssa among others, though the church has generally not affirmed universal salvation and the New Testament's warnings are severe and real.",
      "Refuse both cheap versions. The preacher who relishes the fire has not understood the God he claims to serve, and the sentimentalist who empties the warnings has not read the pages he is quoting. What the tradition guards is narrower and more sober than either: that a person can finally, really refuse God, and that the refusal is not nothing. The far country's exact geography is contested. That it can be chosen is the claim.",
    ],
    essaySlug: "is-hell-eternal",
    essayTitle: "Is Hell Forever, or Does It End?",
    bookTitle: "Heaven Is Not Your Reward",
    bookHref: "/heaven-is-not-your-reward",
  },
  {
    slug: "does-god-choose-us-or-do-we-choose-him",
    question: "Does God choose us, or do we choose him?",
    paragraphs: [
      "This is a second-order question. It divides Calvinist and Arminian churches that preach the same gospel and confess the same creeds, and it is not the confessional floor. You can close this page holding either answer and remain a brother, so I am going to hand you both at their strongest rather than pick your side for you.",
      "The Reformed case is that salvation is entirely God's initiative, so that no one may boast. He \"chose us in him before the foundation of the world\" and predestined us for adoption according to the purpose of his will (Ephesians 1:4-5), and Romans 9 presses that it depends not on human will or exertion but on God who has mercy. The pastoral comfort is enormous: your salvation does not finally rest on the strength of your grip. The Arminian case is that God genuinely desires all to be saved (1 Timothy 2:3-4), that grace goes before and enables a real human response, and that love which cannot be refused is not love. \"Whoever believes\" (John 3:16) is not a formality, and human responsibility is not a fiction.",
      "Scripture holds both in the same breath. Paul tells the Philippians to work out their own salvation, and in the very next clause says it is God who works in them (Philippians 2:12-13). Each side has an overreach to guard against: a determinism that makes God the author of sin, and a human choice that quietly becomes a work. As a convert I could never tell whether I had found God or been found by him. The honest answer the text gives is yes.",
    ],
    essaySlug: "predestination-and-free-will",
    essayTitle: "Predestination vs. Free Will: What Does the Bible Teach?",
    bookTitle: "Why Not What",
    bookHref: "/why-not-what",
  },
  {
    slug: "how-should-a-christian-read-genesis-1",
    question: "How should a Christian read Genesis 1?",
    paragraphs: [
      "Start by separating what is binding from what is open, because most of the heat in this argument comes from confusing the two. That God created, that he created from nothing, and that humanity bears his image are first-order and non-negotiable. The age of the earth and the mode of creation are third-order and genuinely open, and faithful Christians who love the same Bible have landed in different places.",
      "Three readings are held by people who take Scripture seriously. Young-earth creationism reads six ordinary days and a recent creation, out of a concern to protect the plain sense of the text and the theological weight of a historical Adam. Old-earth and literary-framework readings, including the framework view associated with Meredith Kline, take the days as an ordered literary structure or long ages and take deep time seriously while holding the text as true. Evolutionary creation, argued by Francis Collins and others at BioLogos, holds that God created through the evolutionary process and that Genesis 1 is theological rather than scientific literature. All three confess the same Creator.",
  ...
  {
    slug: "what-does-the-bible-say-about-divorce-and-remarriage",
    question: "What does the Bible say about divorce and remarriage?",
    paragraphs: [
      "Jesus begins where we would rather not, with the permanence. \"So they are no longer two but one flesh. What therefore God has joined together, let not man separate\" (Matthew 19:6). Divorce is not a neutral administrative event. It is the tearing of something God joined, and every honest treatment has to start by saying so rather than by managing around it.",
      "But Scripture itself names exceptions, and the church has read them faithfully in more than one way. Jesus permits divorce for sexual immorality (Matthew 19:9), and Paul addresses the believer whose unbelieving spouse leaves, saying the brother or sister is not enslaved in such cases and that God has called us to peace (1 Corinthians 7:15). Christians who take both texts seriously still differ on how far those exceptions extend, particularly regarding abuse and abandonment in their modern forms, and I am not going to hand you a ruling on your marriage from a web page.",
      "What I will say is that the church has often gotten the weighting exactly backwards. It has treated the divorced as a permanent category of failure while quietly tolerating the contempt, neglect, and cruelty that killed the marriage long before the paperwork. If you are in danger, get safe first and sort the theology after. If you are grieving a marriage that ended, you are not a second-class Christian. Grace is not the reward for a clean history.",
    ],
    essaySlug: "divorce-and-remarriage",
    essayTitle: "What Does the Bible Say About Divorce and Remarriage?",
    bookTitle: "Covenant",
    bookHref: "/covenant",
  },
  {
    slug: "why-does-god-allow-natural-disasters",
    question: "Why does God allow earthquakes, cancer, and animal suffering?",
    paragraphs: [
      "This is the harder half of the problem of evil, and most answers never reach it. Free will can be offered as an account of the torturer. It says nothing about the tsunami, the child's leukemia, or the millions of years of predation and parasitism that ran long before any human could sin. The philosopher William Rowe put the sharpest form of it in 1979: a fawn burned in a forest fire, dying in agony over days, with no human to witness or learn from it. That suffering looks simply pointless, and I will not pretend otherwise.",
      "What can honestly be said is smaller than a solution. A world stable enough for embodied creatures to act, build, and love at all may be a world running on fixed laws, and the same physics that lets bone grow lets it break. Scripture refuses to call the present arrangement the intended one: the creation \"was subjected to futility\" and groans together in the pains of childbirth until now (Romans 8:20-22). And when Job demanded an explanation, God answered with his own presence and the wild otherness of creation rather than a theodicy.",
      "None of that closes the fawn, and any answer that claims to has stopped being honest. The Christian claim is not that the suffering makes sense now. It is that it is neither the last word nor the intended word, and that God did not stay outside it explaining. He entered it. If you are in the middle of this, you do not need my argument. You need someone to sit with you, and that is the church's actual job.",
    ],
    essaySlug: "natural-evil-and-animal-suffering",
    essayTitle: "The Suffering God Never Ordered",
    bookTitle: "Prayer in the Dark",
    bookHref: "/prayer-in-the-dark",
  },
  {
    slug: "what-makes-us-human-in-the-age-of-ai",
    question: "What makes us human in the age of AI?",
    paragraphs: [
      "The functionalist case deserves to be stated at full strength before anyone answers it. If the mind simply is information processing, then a human being is a wet computer, and a sufficiently advanced machine that reasons, converses, and reports feeling would be a person in every way that counts. To deny it would be mere carbon chauvinism. The machines are now good enough that this is not science fiction, and much of what we prized as uniquely human, including calculation, fluency, and a kind of creativity, turns out to be reproducible. That should humble us.",
      "The Christian answer is not that humans compute better. It is that personhood was never a capacity in the first place. If it were, the infant, the demented, and the profoundly disabled would be less than persons, which is precisely the road no one should want to walk. \"So God created man in his own image\" (Genesis 1:27), formed from dust and given breath (Genesis 2:7). A person is one who is made and loved and named by God, and that is conferred rather than earned or benchmarked.",
