...
export const DISRUPTION: SectionConfig = {
  ...
  tools: [
    { href: "/nation", title: "Christ and the Nation", desc: "Was America a Christian nation? How close is each party to the Bible? What a biblical government would actually mean." },
    ...
    { href: "/lament", title: "The lament and the hope", desc: "Prayers to grieve injustice and confess the church's failure, and the vision of the world set right." },
  ...
  topics: [
    ...
    { slug: "moralistic-therapeutic-deism", group: "Cultural Captivity", title: "Moralistic Therapeutic Deism", blurb: "The actual folk faith of much of the American church, right and left alike, from Christian Smith's landmark study. A God who wants us nice and happy and otherwise stays out of the way.", ready: true },
