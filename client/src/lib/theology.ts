...
export const DOCTRINE_INDEX: DoctrineIndexEntry[] = [
  ...
  { slug: "church-and-state", pillar: "Systematic", title: "Christ and Caesar: Church and State", blurb: "Two kingdoms, transformationalism, the Anabaptist witness, Augustine's two cities, and theonomy. How the church has understood its relationship to political power, stated fairly and weighed.", triage: "second-order", ready: true },
