    ...
    <Layout>
      ...
      <section style={{ background: "var(--charcoal)", padding: "80px 24px" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <Link href="/writing/young-adults-coming-back-church" style={{ textDecoration: "none" }}>
