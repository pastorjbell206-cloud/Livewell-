    ...
    <div style={{ background: "var(--paper)" }}>
      ...
      <section style={{ background: "var(--paper2)", padding: "72px 20px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>The church has too often treated a hard question as a threat to be managed, and so it taught a generation to choose between honesty and belonging. That was a false choice, and it cost us — I have watched it cost people I love. The ones who kept asking were not the weak ones. They were the ones who took God seriously enough to want him to be real.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>There is a reason the doubt feels heavier now than it did for your grandparents. We live, as the philosopher Charles Taylor described it, inside an immanent frame — a world that runs so smoothly without reference to God that belief has come to feel like effort and unbelief like the default. That is the water we swim in. It does not make the questions false. It means the ache you feel is not a private failure of faith so much as the cost of being awake in a disenchanted century.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>But the faith has sat in this dark before, and it wrote the darkness down. A third of the Psalms are complaints. "How long, O Lord?" is not a crisis the Bible edits out; it is a prayer the Bible hands you to pray. Job argued with God through nearly forty chapters and was told, in the end, that he alone had spoken rightly — while his friends, who defended God with tidy answers, were rebuked. Thomas wanted to touch the wounds before he would believe, and Jesus did not shame him. He showed him his hands.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>Even the saints knew the silence. In the sixteenth century John of the Cross gave it a name — the dark night of the soul, the felt absence of a God you have not stopped believing in. When Mother Teresa's private letters were published after her death, they revealed a woman who served the dying of Calcutta for decades while feeling, most days, that heaven was closed. She did not leave. She had learned the difference between the absence of feeling and the absence of God.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "0" }}>So bring the question. It is safer inside the faith than outside it — not because the faith is afraid of it, but because the faith has room for it that the alternatives do not. And if the darkness has turned into the kind that frightens you, do not carry it alone: tell a pastor, a friend, a counselor who will stay in the room with you. The doubt is not the end of anything. It may be the beginning of a faith with the weight to hold a life.</p>
          </div>
      </section>
