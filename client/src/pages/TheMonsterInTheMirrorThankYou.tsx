/**
 * Post-purchase download page for The Monster in the Mirror. Stripe's Payment
...
const DIR = "/ebook/the-monster-in-the-mirror";
const EPUB = `${DIR}/The-Monster-in-the-Mirror.epub`;
const PDF = `${DIR}/The-Monster-in-the-Mirror.pdf`;
...
export default function TheMonsterInTheMirrorThankYou() {
  return (
    <Layout>
      <SEOMeta title="Thank you — your download" description="Download your copy of The Monster in the Mirror." noindex />
      <section style={{ background: "var(--bone)", padding: "var(--s-6) var(--s-4)", minHeight: "60vh" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "14px", color: "var(--ink-muted)", marginTop: "40px" }}>
            ...
            and we'll send your files directly. <Link href="/books/the-monster-in-the-mirror" style={{ color: "var(--ink)", borderBottom: "1px solid var(--mustard)" }}>Back to the book</Link>.
          </p>
        </div>
      </section>
    </Layout>
