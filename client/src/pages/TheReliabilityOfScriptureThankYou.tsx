/**
 * Post-purchase download page for The Reliability of Scripture. Stripe's Payment
 * Link is configured to redirect here after a successful payment. Links the
 * EPUB + PDF directly.
 */
...
const DIR = "/ebook/the-reliability-of-scripture";
const EPUB = `${DIR}/The-Reliability-of-Scripture.epub`;
const PDF = `${DIR}/The-Reliability-of-Scripture.pdf`;
...
export default function TheReliabilityOfScriptureThankYou() {
  return (
    <Layout>
      <SEOMeta title="Thank you — your download" description="Download your copy of The Reliability of Scripture." noindex />
      <section style={{ background: "var(--bone)", padding: "var(--s-6) var(--s-4)", minHeight: "60vh" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.7, color: "var(--ink-muted)", maxWidth: "54ch", margin: "0 auto 36px" }}>
            Thank you for buying <em>The Reliability of Scripture</em>. Download both formats below — the EPUB for your e-reader or phone, the PDF for everything else. The links stay on this page, so bookmark it.
          </p>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "14px", color: "var(--ink-muted)", marginTop: "40px" }}>
            ...
            and we'll send your files directly. <Link href="/books/the-reliability-of-scripture" style={{ color: "var(--ink)", borderBottom: "1px solid var(--mustard)" }}>Back to the book</Link>.
          </p>
        </div>
      </section>
    </Layout>
