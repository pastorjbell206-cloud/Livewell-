/**
 * Post-purchase download page for the ebook. Stripe's Payment Link is configured
...
const DIR = "/ebook/when-god-bless-america";
const EPUB = `${DIR}/When-God-Bless-America.epub`;
const PDF = `${DIR}/When-God-Bless-America.pdf`;
...
export default function WhenGodBlessAmericaThankYou() {
  return (
    <Layout>
      <SEOMeta title="Thank you — your download" description="Download your copy of When God Bless America Replaces Thy Kingdom Come." noindex />
      <section style={{ background: "var(--bone)", padding: "var(--s-6) var(--s-4)", minHeight: "60vh" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "14px", color: "var(--ink-muted)", marginTop: "40px" }}>
            ...
            and we’ll send your files directly. <Link href="/books/when-god-bless-america" style={{ color: "var(--ink)", borderBottom: "1px solid var(--mustard)" }}>Back to the book</Link>.
          </p>
        </div>
      </section>
    </Layout>
