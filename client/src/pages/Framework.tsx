...
const MOVES = [
  {
    ...
    href: "/theology",
    body: "Start with what is true, handled honestly. That means the actual questions rather than a position handed down to be defended, every serious view stated in its strongest voice, and the councils and confessions that paid for the words traced with care. You cannot live what you have only been told to repeat.",
  },
  {
    n: "02",
    verb: "Trace it",
    ...
    body: "Then watch it move. Scripture is one story, from a garden to a city, with a cross at the hinge, and kingdom, temple, covenant, exile, and sacrifice all bend toward the same person. Doctrine gives the faith its skeleton, but the storyline is the body that walks.",
  },
  {
    n: "03",
    ...
    href: "/disruption",
    body: "Before the truth can form you, the counterfeits have to die, and most of them do not look like idols. They look like the nation dressed as the kingdom, the market that has quietly become a god, the platform, the party, and the nostalgia for a country that was never Jerusalem. We swim in that water and rarely name it, and I include myself in the we. This is the part that costs you your tribe.",
  },
  {
    n: "04",
    verb: "Do justice",
    ...
    href: "/justice",
    body: "Truth that does not reach the poor at the gate was never the truth of this God. The prophets called it mishpat and tsedaqah, and they meant the widow, the immigrant, and the worker, which is why the church's long silence about them, and the few who broke it, belong in this wing. Justice is not a program bolted onto the gospel. It is the shape the gospel takes when it touches the ground.",
  },
  {
    n: "05",
    ...
    href: "/life",
    body: "And then the whole of it becomes a life: the body, the marriage, the calendar, the bank account, the friendship, the grief. Leaders are formed before they are deployed, character before competence, and the ordinary believer learns to offer one undivided life, whole, on an ordinary Tuesday. This is where all of it was always going.",
  },
];
