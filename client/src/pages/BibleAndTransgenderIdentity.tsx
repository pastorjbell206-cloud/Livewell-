        ...
        <div className="book-detail-hero" style={{ maxWidth: "var(--w-content)", margin: "0 auto", display: "grid", gap: "var(--s-5)", alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "18px", flexWrap: "wrap" }}>
              <BuyEbookButton slug="bible-and-transgender-identity" title="What the Bible Says About Transgender Identity" label="Get the ebook — $8.99" fallbackLink={PAYMENT_LINK} />
