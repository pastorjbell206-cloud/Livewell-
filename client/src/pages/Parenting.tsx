    ...
    <div style={{ background: "var(--paper)" }}>
      ...
      <section style={{ background: "var(--bone-warm)", padding: "72px 20px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>There is research underneath this, and it is humbling. When the National Study of Youth and Religion followed American teenagers through the early 2000s, Christian Smith found that the strongest predictor of a young person's faith was not the youth group, the school, or the music. It was the practiced faith of their parents. Smith also named what most of those teenagers had actually absorbed. Moralistic therapeutic deism: a god who wants you to be nice, wants you to feel good about yourself, and otherwise stays out of the way. They did not invent that god. They learned him from us.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>The oldest instruction assumes as much. Deuteronomy 6 tells parents to keep the words on their own hearts first, and only then to speak of them sitting in the house, walking by the way, lying down and rising: in the car, at the table, at bedtime, in the ordinary hours nobody photographs. Not a curriculum. A household. Augustine credited his conversion in part to a mother who prayed for him for years while he was busy proving her wrong, which is the long view this asks of you and the only honest one. I have five sons, and I have been the inconsistent man in that house more often than I want to write down.</p>
