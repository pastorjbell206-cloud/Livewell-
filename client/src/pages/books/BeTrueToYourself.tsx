/**
 * Be True to Yourself (/be-true-to-yourself). The ebook sales page: cover, pitch,
 * a free sample (the opening, served from /books/be-true-to-yourself-sample.md),
 * and a Buy button. The full book is delivered as a gated PDF via /api/checkout
...
const SLUG = "be-true-to-yourself";
...
export default function BeTrueToYourself() {
        ...
        <div style={{ ...prose, display: "flex", gap: "44px", alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 320px" }}>
            <div style={{ fontFamily: "var(--U)", fontSize: "0.75rem", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.18em", color: "var(--mustard)" }}>
              New Ebook · The Religion of the Self
            </div>
      ...
      <section style={{ background: "var(--ink)", color: "var(--bone)", padding: "var(--s-6) var(--s-4)" }}>
        <div style={{ ...prose, textAlign: "center" }}>
          <p style={{ fontFamily: "var(--F)", fontSize: "24px", fontStyle: "italic", margin: "0 0 22px", color: "rgba(245,240,230,.92)" }}>
            You are not your own. The age hears a prison sentence. It is the only thing that was ever a release.
          </p>
