/**
 * Post-purchase download page for Believe. Stripe's Buy Button is configured
...
const DIR = "/ebook/believe";
const EPUB = `${DIR}/Believe.epub`;
const PDF = `${DIR}/Believe.pdf`;
...
export default function BelieveThankYou() {
  return (
    <Layout>
      <SEOMeta title="Thank you — your download" description="Download your copy of Believe." noindex />
      <section style={{ background: "var(--bone)", padding: "var(--s-6) var(--s-4)", minHeight: "60vh" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.7, color: "var(--ink-muted)", maxWidth: "54ch", margin: "0 auto 36px" }}>
            Thank you for buying <em>Believe</em>. Download both formats below — the EPUB for your e-reader or phone, the PDF for everything else. The links stay on this page, so bookmark it.
          </p>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "14px", color: "var(--ink-muted)", marginTop: "40px" }}>
            ...
            and we'll send your files directly. <Link href="/books/believe" style={{ color: "var(--ink)", borderBottom: "1px solid var(--mustard)" }}>Back to the book</Link>.
          </p>
        </div>
      </section>
    </Layout>
