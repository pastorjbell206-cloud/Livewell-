    ...
    <div style={{ background: "var(--bone)" }}>
      ...
      <section style={{ background: "var(--bone-warm)", padding: "72px 20px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>The shift was not an accident, and it is younger than it feels. For most of human history people married for reasons larger than themselves: land, lineage, survival, children who would one day bury them. In <em>Habits of the Heart</em> (1985) Robert Bellah described what replaced those reasons: a therapeutic account of love, in which the relationship exists to meet the emotional needs of the two people inside it and is judged by how well it performs. The sociologist Andrew Cherlin named the result the deinstitutionalization of marriage. The ceremony survived. The scaffolding that once held it up did not.</p>
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.8, color: "var(--ink)", maxWidth: "68ch", marginBottom: "22px" }}>The old vows knew what they were asking. For better for worse, for richer for poorer, in sickness and in health. That is not romantic language. It is a list of the exact conditions under which people leave, named out loud in advance and promised against anyway. Scripture is no more sentimental about it. Malachi calls the wife of your youth your companion and your wife by covenant; Ephesians 5 holds the whole arrangement up as a picture of Christ and the church, which is to say a love proved by what it absorbs rather than by what it receives. I have stood with couples while they said those words, and I have needed them myself.</p>
