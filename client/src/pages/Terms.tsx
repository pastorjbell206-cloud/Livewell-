    ...
    <Layout>
      ...
      <div className="wrap" style={{ maxWidth: "800px", padding: "60px 32px" }}>
        ...
        <div style={{ fontFamily: "var(--B)", fontSize: "16px", lineHeight: "1.8", color: "var(--ink2)" }}>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Content</h2>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Fair Use</h2>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Ebook Purchases and Refunds</h2>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Membership</h2>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Disclaimer</h2>
          ...
          <h2 style={{ fontSize: "22px", fontFamily: "var(--F)", fontWeight: 500, margin: "32px 0 12px", color: "var(--ink)" }}>Contact</h2>
