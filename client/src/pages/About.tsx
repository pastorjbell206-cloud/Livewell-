      ...
      <section style={{ background: "var(--charcoal)", padding: "var(--s-7) var(--s-3) var(--s-6)" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "2.5rem", alignItems: "flex-start", flexWrap: "wrap", marginBottom: "3rem" }}>
            {/* .toned: the duotone lock — grades the portrait to the palette (docs/IMAGE-AND-DESIGN-DIRECTION.md) */}
            <div className="toned" style={{ borderRadius: "2px", border: "1px solid rgba(244,241,234,0.1)", flexShrink: 0, overflow: "hidden" }}>
              <img src={PORTRAIT} alt="James Bell" loading="eager" width={160} height={210} style={{ width: "160px", height: "210px", objectFit: "cover", objectPosition: "center top" }} />
            </div>
