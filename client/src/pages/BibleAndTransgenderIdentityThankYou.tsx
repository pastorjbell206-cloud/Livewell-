/**
 * Post-purchase download page for What Does the Bible Say About Transgender
 * Identity? Stripe's Payment Link is configured to redirect here after a
...
const DIR = "/ebook/bible-and-transgender-identity";
const EPUB = `${DIR}/What-the-Bible-Says-About-Transgender-Identity.epub`;
const PDF = `${DIR}/What-the-Bible-Says-About-Transgender-Identity.pdf`;
...
export default function BibleAndTransgenderIdentityThankYou() {
  return (
    <Layout>
      <SEOMeta title="Thank you — your download" description="Download your copy of What Does the Bible Say About Transgender Identity?" noindex />
      <section style={{ background: "var(--bone)", padding: "var(--s-6) var(--s-4)", minHeight: "60vh" }}>
        <div style={{ maxWidth: "var(--w-prose)", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "18px", lineHeight: 1.7, color: "var(--ink-muted)", maxWidth: "54ch", margin: "0 auto 36px" }}>
            Thank you for buying <em>What Does the Bible Say About Transgender Identity?</em> Download both formats below — the EPUB for your e-reader or phone, the PDF for everything else. The links stay on this page, so bookmark it.
          </p>
          ...
          <p style={{ fontFamily: "var(--B)", fontSize: "14px", color: "var(--ink-muted)", marginTop: "40px" }}>
            ...
            and we'll send your files directly. <Link href="/books/bible-and-transgender-identity" style={{ color: "var(--ink)", borderBottom: "1px solid var(--mustard)" }}>Back to the book</Link>.
          </p>
        </div>
      </section>
    </Layout>
