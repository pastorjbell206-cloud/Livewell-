...
const TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    significance: "The Imago Dei is the theological foundation of human rights. Every person — regardless of race, gender, age, ability, productivity, or moral record — bears the image of God. This is not a sentiment; it is a claim about human worth that no ethics without God has managed to ground.",
  ...
  },
  {
    ...
    significance: "Kenosis shapes the Christian understanding of power: true power is not grasping but releasing; true greatness is not self-assertion but self-giving. It runs against nearly everything the age teaches about power.",
  ...
  },
  {
    ...
    significance: "Legalism is a temptation the church never quite outgrows, not because rules are bad but because rule-keeping feels safer than grace. Grace requires trust; rules require only effort. And effort is something the ego can control.",
