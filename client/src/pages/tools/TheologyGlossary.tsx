...
const TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    originalLanguage: "Latin: inclusio (an enclosing); the device appears in Hebrew (charaktir) and Greek texts",
  },
  {
    term: "Typology",
    category: "Biblical Studies",
