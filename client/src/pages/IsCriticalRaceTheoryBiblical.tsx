...
const PAYMENT_LINK = "https://buy.stripe.com/aFadR983A8RMeG2gPMa3u08";
        ...
        <div className="book-detail-hero" style={{ maxWidth: "var(--w-content)", margin: "0 auto", display: "grid", gap: "var(--s-5)", alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "18px", flexWrap: "wrap" }}>
              <BuyEbookButton slug="critical-race-theory-biblical" title="Is Critical Race Theory Biblical?" label="Get the ebook — $8.99" fallbackLink={PAYMENT_LINK} />
