      ...
      <section style={{ background: "var(--charcoal)", padding: "7rem 1.5rem", minHeight: "55vh" }}>
        <div style={{ maxWidth: "620px", margin: "0 auto", textAlign: "center" }}>
          ...
          {!sessionId || sessionQuery.isError ? (
            <>
              <h1 style={{ fontFamily: "var(--F)", fontSize: "clamp(1.8rem, 4vw, 2.5rem)", fontWeight: 400, color: "var(--charcoal-fg)", marginBottom: "1.25rem" }}>We could not confirm that checkout</h1>
              <p style={{ fontFamily: "var(--B)", fontSize: "1rem", lineHeight: 1.7, color: "var(--charcoal-fg)", opacity: 0.75, marginBottom: "2rem" }}>
            ...
            <p style={{ fontFamily: "var(--B)", color: "var(--charcoal-fg)", opacity: 0.75 }}>Confirming your membership…</p>
          ) : (
            <>
              <h1 style={{ fontFamily: "var(--F)", fontSize: "clamp(1.8rem, 4vw, 2.5rem)", fontWeight: 400, color: "var(--charcoal-fg)", marginBottom: "1.25rem" }}>You are in the room</h1>
              <p style={{ fontFamily: "var(--B)", fontSize: "1rem", lineHeight: 1.7, color: "var(--charcoal-fg)", opacity: 0.75, marginBottom: "1rem" }}>
              ...
              <p style={{ fontFamily: "var(--F)", fontSize: "1.05rem", fontStyle: "italic", lineHeight: 1.6, color: "var(--charcoal-fg)", opacity: 0.85, marginBottom: "2.5rem" }}>
