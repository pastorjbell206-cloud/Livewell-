...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#111111", color: "#ffffff", padding: "60px 20px 20px", marginTop: "60px", borderTop: "3px solid #D4A017" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "40px", marginBottom: "40px" }}>
          {/* Column 1 - Brand */}
          <div>
            <div style={{ fontSize: "22px", fontWeight: "bold", color: "#D4A017", marginBottom: "12px", fontFamily: "Georgia, serif" }}>LiveWell</div>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <a href="https://substack.com/@jamesbell333289" target="_blank" rel="noopener noreferrer" style={{ color: "#D4A017", fontSize: "12px", textDecoration: "none", fontWeight: "600" }}>Substack →</a>
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div style={{ borderTop: "1px solid #D4A017", paddingTop: "20px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px", fontSize: "12px", color: "#D1C9BB" }}>
