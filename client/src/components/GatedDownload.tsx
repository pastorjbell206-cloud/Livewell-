  ...
  if (unlocked) {
    return (
      <a
        ...
        style={{ display: "inline-flex", alignItems: "center", gap: "8px", fontFamily: "var(--U)", fontSize: "14px", fontWeight: 600, color: "var(--bone)", background: "var(--charcoal)", padding: "11px 18px", textDecoration: "none", borderRadius: "2px" }}
      >
  ...
  if (!open) {
    return (
      <button
        ...
        style={{ display: "inline-flex", alignItems: "center", gap: "8px", fontFamily: "var(--U)", fontSize: "14px", fontWeight: 600, color: "var(--bone)", background: "var(--charcoal)", padding: "11px 18px", border: "none", borderRadius: "2px", cursor: "pointer" }}
      >
        <Download size={15} /> {label}
      </button>
    );
