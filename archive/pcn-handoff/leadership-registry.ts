...
export const LEADERSHIP_TOOLS: ToolLink[] = [
  ...
  { href: "/leadership/inventory", kicker: "Inventory", title: "The Leadership Formation Inventory", blurb: "The flagship: a character-first diagnostic across identity, ego, rest, the hidden life, and emotional health — before any question of skill. Retakeable, kept in your browser." },
